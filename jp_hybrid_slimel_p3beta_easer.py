...
slim_p3beta_study = optuna.create_study(
...
slim_p3beta_easer_study = optuna.create_study(
...
rp3beta_recommender.fit(**p3beta_study.best_params)

recommender_object_1 = DifferentLossScoresHybridRecommender(data_train, slim_el_recommender, rp3beta_recommender)
recommender_object_1.fit(**slim_p3beta_study.best_params)
...
def objective(trial):
    ...
    recommender_object_2 = DifferentLossScoresHybridRecommender(data_train, recommender_object_1, easer_recommender)
...
slim_p3beta_easer_study.optimize(objective, n_trials=200)
